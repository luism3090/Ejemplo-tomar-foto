<html>
 ...
 <style type="text/css">
	...
	<form action="subir.php" enctype="multipart/form-data" method="post" >
		...
		<input type ="hidden" name="uu" id="uu" value="<?php echo $_POST['uu']?>" />
		...
		<!-- <input id="botonGuardar" type="submit" value="Guardar"></input>-->
		<input id="botonDescargar" type="button" value="Guardar"></input>
		</div>
